...
class AppraisalPeriod(models.Model):
    ...
    comentario_general = fields.Html(string='Comentarios generales')
    ...
    def compute_appraisal_behavior_lines(self):
    ...
    appraisal_behavior_lines = fields.One2many('appraisal.behavior', 'appraisal_period_id', string='Competencias', store=True, compute="compute_appraisal_behavior_lines")
